...
@Component({
    selector: 'app-library-background-wizard',
    templateUrl: './library-background-wizard.component.html',
    styleUrl: './library-background-wizard.component.scss',
})
export class LibraryBackgroundWizardComponent implements OnInit, OnDestroy {
