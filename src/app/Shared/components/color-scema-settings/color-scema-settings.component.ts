...
import { ColorScheme, LayoutService, MenuMode } from 'src/app/layout/app-services/app.layout.service';
@Component({
    selector: 'app-color-scema-settings',
    templateUrl: './color-scema-settings.component.html',
    styleUrl: './color-scema-settings.component.scss',
})
export class ColorScemaSettingsComponent {
